...
//! Forces dynamic linking of Tauri.
//!
//! Dynamic linking causes Tauri to be built and linked as a dynamic library. This will make
...
//! `libstd.so` and `libtauri_dylib.so` with your application.
//!
...
// Force linking of the main tauri crate
#[allow(unused_imports)]
pub use tauri_core::*;
